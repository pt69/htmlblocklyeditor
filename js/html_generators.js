...
HtmlGenerator['css_classes'] = function(block) {
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  var code = '<style>\n' + statements_content + '</style>\n';
  return code;
};

HtmlGenerator['css_class'] = function(block) {
...
HtmlGenerator['css_tag'] = function(block) {
  var class_name = block.getFieldValue('NAME');
  var statements_content = HtmlGenerator.statementToCode(block, 'content');
  var code = class_name + ' {\n' + statements_content + '}\n';
  return code;
...
HtmlGenerator['css_classdock'] = function(block) {
  var class_name = block.getFieldValue('NAME');
  var code = ' class="' + class_name + '"';
  return [code, HtmlGenerator.ORDER_NONE];
};

HtmlGenerator['css_attribut'] = function(block) {
...
HtmlGenerator['css_bgcolour'] = function(block) {
  var colour_name = block.getFieldValue('NAME');
